...
## Load test and train data sets and label them with descriptive variable names (features).
...
## Load activity code for each observation and merge codes with descriptive activity names
